...
### 1. Veri Setinin Hazırlanması ve İçeriğin Aktarılması
...
### 2. Tematik Analiz için Kodlama Süreci
...
### 3. MAXQDA ile Kodlama Teknikleri
...
### 4. Temaların Görselleştirilmesi ve Analiz Sonuçlarının Yorumlanması
...
![Maxqda ile tematik analiz, Attride-Stirling'in (2001) Tematik Ağ (Thematic Network) Yöntemi](./image-2.webp)
